...
<Button ID="powButton" runat="server" OnServerClick="powButton_Click" style="height:2em;" >
    x<sup>2</sup>
</Button>
<Button ID="sqrtButton" runat="server" OnServerClick="sqrtButton_Click" style="height:2em;" >
